...
from A2C.a2c.hyreal_a2c_AUTOBOTS_COG import HyREALA2C_AUTOBOTS_COG
...
def run(args):
    ...
    agent = HyREALA2C_AUTOBOTS_COG(env.world, env.map, env.scene,conn=None)
...
if __name__ == '__main__':
    ...
    args.config = os.path.join('./hyreal_lite/config', "hyreal_cog.yaml")
