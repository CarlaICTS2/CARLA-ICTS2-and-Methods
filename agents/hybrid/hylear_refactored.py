...
class HyLEAR_NavA2C(ISDespotP):
    ...
    def __init__(self, client, world, carla_map, scenario):
        ...
        super(HyLEAR_NavA2C, self).__init__(client, world, carla_map, scenario)
    ...
    def run_step(self, step_counter: int):
        ...
        if len(obstacles):
            ...
            (self.step_agent_vehicle_future_trajectory, risk) = super(HyLEAR_NavA2C, self).get_path_simple(start, end, obstacles)
        ...
        if Config.MODE is Mode.TRAIN:
            ...
            if learner_action is Action.DECELERATE:
                ...
                agent_vehicle_control.throttle = 1.0
        ...
        print("Step Summary: CONTROL:", agent_vehicle_control)
        return step_summary
